    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        <Card title="Planning and Strategy " icon={<AceternityIcon order="Phase 1   " />}
         description="We will collaborate to map put your website's goals, target audiance, and key functionalities. We will discuss things like site structure, navigation, and content requiremnets."
        ...
        description="Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketches to polished code, I keep you updted every step of the way."
...
<button className="p-[3px] relative">
  ...
  <div className="px-8 py-2  bg-black rounded-[6px]  relative group transition duration-200 text-white hover:bg-transparent text-2xl">
    {order}
  </div>
</button>
